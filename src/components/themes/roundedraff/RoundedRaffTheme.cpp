...
// #include <HalPowerManager.h>  // ChineseType 沒此 lib
#include <SDCardManager.h>  // ChineseType 用 SdMan 替代 Carousel 的 Storage
// #include <I18n.h>  // ChineseType 沒翻譯系統，tr() 字串改寫死中文
...
#include "Battery.h"  // ChineseType 全域 battery 物件
...
void RoundedRaffTheme::drawHeader(const GfxRenderer& renderer, Rect rect, const char* title,
  ...
  const uint16_t percentage = battery.readPercentage();  // ChineseType 用 battery 取代 Carousel 的 powerManager
